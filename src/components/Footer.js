        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-300 hover:text-secondary-400 transition-colors duration-200 flex items-center gap-2 group">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919054372690" className="hover:text-secondary-400 transition-colors">+91 9054372690</a>
              </li>
            </ul>
          </div>
        </div>
